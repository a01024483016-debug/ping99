...
# ==========================
# 1) 내 계정 전체 쓰레드 목록 가져오기
# ==========================
def fetch_all_posts(threads_user_id: str | None = None,
                    limit_per_page: int = 50,
                    max_pages: int = 50):
    """
    내 계정의 모든 쓰레드를 페이지네이션 돌면서 끝까지 수집
...
if __name__ == "__main__":
    # 1) 내 계정 전체 쓰레드 가져오기
    raw_posts = fetch_all_posts(THREADS_USER_ID, limit_per_page=50, max_pages=50)
    ...
    output_path = "threads_my_posts_v1.csv"
